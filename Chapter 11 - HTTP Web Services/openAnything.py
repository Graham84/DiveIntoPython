# Amazon API (http://www.amazon.com/webservices)
# National Weather Service (http://www.nws.noaaa.gov/alerts/)
# Hong Kong Observatory (http://demo.xml.weather.gov.hk/)
# Atom API (http://atomenabled.org)
# Syndicated feeds (http://syndic8.com/)
